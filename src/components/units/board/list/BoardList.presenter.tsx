import {Wrapper, WrapperRow, WrapperColumn, HeaderRow, Author, ID, Title, CreatedAt, SelectDelete} from './BoardList.styles'
            ...
            <WrapperColumn>
                <WrapperRow>
                    ...
                    <WrapperRow>
                        ...
                        <CreatedAt>{data.createdAt.slice(0,10).replaceAll("-",".")}</CreatedAt>
                    </WrapperRow>
                )}
