...
import { IMutation, IMutationCreateBoardArgs } from '../../../../commons/types/generated/types.s'
...
export default function BoardWrite() {
	...
	const onClickRegister = async (event: MouseEvent<HTMLButtonElement, MouseEvent>) => {
        try {
