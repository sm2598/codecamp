...
const MarketListUI = ({bestItems, onClickSearch, onChangeSearch, usedItems, currentPage, onClickPage, onLeftArrowClick, onLeftFirstArrowClick, holder, onRightArrowClick, onRightLastArrowClick}) => {
        ...
        <WrapperColumn>
          <WrapperRowButtonInputs>
              ...
              <WrapperSearchInputDiv>
                <SearchImg src="/search.png" onClick={onClickSearch}/><Search type="input" placeholder="제품을 검색해주세요" onChange={onChangeSearch}
              onKeyDown={handleKeyDown}/>
              </WrapperSearchInputDiv>
              {/* 날짜 */}
              <WrapperRow>
                <ButtonShowType id="recent" isActive={showtype.recent} onClick={onClickShowType}>최신순</ButtonShowType> 
                <ButtonShowType id="hprice" isActive={showtype.hprice} onClick={onClickShowType}>높은가격순</ButtonShowType>
                <ButtonShowType id="lprice" isActive={showtype.lprice} onClick={onClickShowType}>낮은가격순</ButtonShowType>
                <ButtonShowType id="rating" isActive={showtype.rating} onClick={onClickShowType}>평점순</ButtonShowType>
              </WrapperRow>
              <WrapperRow>
                변경하기: 
                {showDisplayChoice
         ...
         <WrapperRowPagination>
          ...
          <ButtonCreateItem onClick={onClickRoutWrite}>상품 등록하기</ButtonCreateItem>
        </WrapperRowPagination>
      </WrapperColumn>
    </Wrapper>
  )
